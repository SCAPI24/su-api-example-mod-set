...
而且会与正在进行的实时联机会话互相干扰。联机世界的权威副本在服务器（`139.155.99.152`），
...
| 证据 | 内容 |
|---|---|
| 游戏日志 | 23:15~23:21 之间用户正在连自己的服务器：`JoinGame sent: ceshi260810 -> 0, server=139.155.99.152:51460` → `[DL] Requesting world` → `World download complete: Bytes=3114927` → `Importing world → data:/Worlds/World`，共 24 次导入记录 |
